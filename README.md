...
| Testos unitaris | Bàsic | Testar el codi per funcionalitats independents | PR|
| UI Forms | Avançat | Formularis HTML | LM|
| Patró Post-Get-Redirect | Avançat | Gestionar formularis HTML | LM PR|
| Testos integració | Avançat | Testos de diferents funcionalitats i d'UI | PR|
